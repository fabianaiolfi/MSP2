...
load(file = here("data", "sp_greens_environmental_bills_distance.Rda"))
load(file = here("data", "sp_greens_all_bills_distance.Rda"))
load(file = here("data", "all_sessions.Rda"))
```
...
**Average Distance between All Bills introduced by SP and Greens**

```{r echo=FALSE, message=FALSE, warning=FALSE}
df_plot <- sp_greens_all_bills_distance %>% 
...
**Average Distance between Environmental Bills introduced by SP and Greens**

```{r echo=FALSE, message=FALSE, warning=FALSE}
df_plot <- sp_greens_environmental_bills_distance %>% 
  left_join(select(all_sessions, ID, StartDate), by = c("SubmissionSession" = "ID")) %>% 
  mutate(session_year = year(StartDate))
