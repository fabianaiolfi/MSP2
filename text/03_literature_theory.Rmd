...
- following the arguments displayed above, i argue that the sp puts forward  bills that touch upon green topics to benefit themselves electorally
- in order to sucessfully poach green voters, i assume that the sp puts forward bills that are substantively similar to the bills put forward by the green party in terms of green issues.
