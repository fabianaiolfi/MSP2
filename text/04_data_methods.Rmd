...
- in order to capture the content similarity between bills introduced by the two parties, i group bills by party and by session and calculate their average position. this average position captures the average semantic meaning of all bills in a group.
