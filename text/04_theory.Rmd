...
In sum, the SP emphasises environmental issues in an effort to win over voters from the GPS, a small party that it perceives to be a threat. The SP does this by proposing parliamentary bills that are similar in content to GPS bills.