...
To sum up, in order to measure the semantic similarity between the parliamentary bills introduced by the SP and GPS, I first group the bills by party and session and then place them in semantic space. I calculate the middle point of each group and then use the Euclidean distance to measure the distance between two groups in the semantic space. The more semantically similar a group of bills are, the smaller the distance between them in semantic space.
