...
I continue with a brief description of the parliamentary bills.
...
- selects survey, as done by 2022 Lütch p. 171
	- survey respondents are asked what the “most important problem” is. i look at the share of people who picked “environment & energy” from a list of wide range of issues as the most important issue to them at the time of the survey (footnote: add list of other reponse possibilities)
	- disadvantage: data only contain measurements in an election year, thus every 4 years, while sessions occur several times per year
	- i thus need a measurement that measures salience more often
- google trends as an alternative
	- compare selects with google trends, incl plot from `08_google_trends.R`
	- i look at the monthly popularity of the search term “climate change” in Switzerland between Jan 2004 and May 2024
	- i pick the search term “climate change” because it covers the same issue/context/grand scheme as the selects question above and also encompasses the salience of environmental topics amongst the public
