...
I consider this electoral success of the GPS to have occurred at the expense of the SP. This is because both parties belong to the same party family and are thus ideologically close. Both parties highlight issues such as social welfare and gender equality and both are pro-union [@linderSchweizerischeDemokratieInstitutionen2017a 132, 136, 137]. When examining both parties in a two-dimensional left-right/liberal-authoritarian ideological space, the SP and GPS are their closest neighbors (see Figure X). Following this spatial argument, both parties are interested in canvassing the same group of voters.
