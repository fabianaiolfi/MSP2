...
----------------------
```
ACM: why bills are particularly suited to test your hypothesis
```
...
### CH as a Case: Description
```
ACM: introduce the Swiss case and why you are deciding to focus on it (why is it relevant?) somewhere in the paper. It should ideally be after the literature review and hypotheses.
```
- relevant bc CH also signed the paris agreement?
