...
- When examining all types of bills put forward by the SP and the GPS, we can see that the average distance between all bills is roughly constant over time (see figure x)
![](../plots/placeholder_embed_distance_all_bills.png)
...
![](../plots/placeholder_embed_distance_env_bills.png)
