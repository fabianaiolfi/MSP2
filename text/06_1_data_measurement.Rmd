...
![](../plots/palceholder_env_bills.png)

- If we break down the number of environmental bills by party, we can see that all parties introduced roughly the same number of bills up until the late 2010s, where the SP and GPS started introducing much more of these bills. Then all parties decrease again except for the GPS
![](../plots/palceholder_env_bills_by_party.png)

- bills by party strength
