...
- When comparing the number of bills tagged with the environmental label to all bills, the number of environmental bills is mostly flat until the early 2010s, where we observe a slow increase up until the late 2010s, after which there is a strong increase (see Figure \ref{fig:env-bills})
