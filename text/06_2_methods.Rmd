...
Model A
\[
\Delta \text{Semantic Distance between SP and Greens} = \beta + \Delta \text{Google Trends Topic Salience} + \varepsilon
\]

Model B
\[
\Delta \text{Semantic Distance}_{t} = \beta + \Delta \text{Google Trends Topic Salience}_{t-1} + \varepsilon
\]

- delta (Δ) indicates the change between two observations
- t-1 indicates the lagged variable
