...
Parties adjust their policies in response to changes by other parties, especially those that are ideologically closer to them [@adamsPolicyAdjustmentParties2009 827-828]. A topic’s saliency [@damoreIssueConvergencePresidential2005] and public opinion on the topic [@lowryPartyDifferentiationCongress2002 43] also play a role in whether parties converge on certain issues. Convergence tends to intensify during election campaigns, as parties aim to match the views of the majority of voters [@spiliotesCampaignAdvertisingPartisan2002 250]. Based on this understanding, I put forward two hypotheses:  
  
**Hypothesis 1**  
The increased saliency of a topic leads to greater convergence among ideologically similar parties on that topic.  

**Hypothesis 2**  
Topic convergence between parties is more pronounced in the run up to an election.
