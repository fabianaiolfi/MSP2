...
```{r embeddings-all-bills, echo=FALSE, fig.pos="H", fig.height = 3, fig.width = 6, message=FALSE, warning=FALSE, fig.cap = "Semantic Distance between SP and GPS Bills over Time (Monthly and Yearly Average)"}
ggplot() +
