...
ggplot() +
  ...
  geom_line(data = gt_climate_change_2004_2022, aes(x = Month, y = climate_change, color = "Data covering 2004-2022")) +
  geom_point(data = gt_climate_change_2004_2022, aes(x = Month, y = climate_change, color = "Data covering 2004-2022"), size = 0.5) +
